<template>
    <div id="shopInside">
        ...
        <div>
            <div>
                <ul class="navColumn">
                    <router-link tag="li" to="/shop" class="title">商品列表</router-link>
                    <li @click="back" class="title">{{product.category}}</li>
            ...
            <div class="row mb-5 mt-4">
                ...
                <div class="shopInside_info col-md-6 col-xl-4">
                        ...
                        <div class="row">
                            ...
                            <div class="addNumber mt-2 col-6">
                                <select name="" class="form-control">
                                    <option :value="item" v-for="item in 10" :key="item.id">{{item}}</option>
                                </select>
                            </div>
                        </div>
                    ...
                    <div class="addShop text-center">
                        <button class="col-5">加入購物車</button>
            ...
            <div class="aboutLike">
                ...
                <div class="info row">
                    <div class="col-sm-6 col-lg-3 mt-4" v-for="(item,key) in moreLook" :key="key">
